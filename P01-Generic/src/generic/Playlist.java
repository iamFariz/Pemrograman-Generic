...
public class Playlist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnFooter.setMaximumSize(new java.awt.Dimension(32767, 50));
    ...
    private void tblPlaylistMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPlaylistMouseClicked
        ...
        if (evt.getClickCount() == 2 && i != -1) {
            ...
            JOptionPane.showMessageDialog(this,
                    "<html>"
                    + "<head>" + "<style>" + "table {border-collapse; border: 1px solid blue;}"
                    ...
                    + "<tr><td>Nama File</td><td>" + m.getFileName() + "</td></tr>"
                    + "<tr><td>Ukuran</td><td>" + m.getFileSize() + "</td></tr>"
                    + "<tr><td>Ekstensi</td><td>" + m.getExtention() + "</td></tr>"
                    + "</table>"
                    + "</body>"
                    + "</html>"
            );
